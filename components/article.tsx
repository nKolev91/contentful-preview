        ...
        <div className="container space-y-12 px-4 md:px-6">
          ...
          <div className="space-y-8 lg:space-y-10">
            <Image
              ...
              height="365"
              src={updatedBlog.featuredImage?.url as string}
              width="650"
              {...ContentfulLivePreview.getProps({
                assetId: updatedBlog.featuredImage?.sys.id || '',
                fieldId: 'file',
              })}
            />
            <div className="space-y-4 md:space-y-6">
              <div className="space-y-2">
                ...
                >
                  {documentToReactComponents(updatedBlog.content.json)}
                </div>
              </div>
            </div>
          </div>
